...
A pi package that creates and enforces frontend design style guides. `pif` turns the design-system blueprint in this repo into a project-local `docs/styleguide/`, builds a deterministic demo, and injects styleguide guidance into pi frontend implementation and review turns.
...
```bash
pi install "/absolute/path/to/pif"
```

For project-local installation:

```bash
pi install -l "/absolute/path/to/pif"
```
...
Private license. This repository is not open source; see `LICENSE`.
