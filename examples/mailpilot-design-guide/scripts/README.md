...
- `validate-tailwind-export.mjs` checks generated Tailwind export files under `tmp/pif/export`, token-family coverage, theme coverage, color contrast, unit rules, utility emission, and fixture compilation.
- `validate-demo.mjs` checks generated demo files under `tmp/pif/demo`, schema conformance, chapter coverage, sidebar targets, placeholder absence, landmarks, labelled form structure, stylesheet linkage, and stale references.
